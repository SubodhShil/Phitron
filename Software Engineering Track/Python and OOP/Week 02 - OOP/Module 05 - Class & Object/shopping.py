...
"""
Antu = Shopping("Antu")
Antu.add_to_cart("Mango", 55, 5)
Antu.add_to_cart("Juice", 120, 3)
Antu.add_to_cart("chips", 15, 2)
Antu.add_to_cart("Biscout", 15, 2)
Antu.add_to_cart("Soya Chunks", 280, 2)
Antu.add_to_cart("Incense Sticks", 220, 1)
Antu.add_to_cart("Laddo", 15, 4)
Antu.checkout(1534)
print()

Antu.remove_cart("Biscout")
Antu.update_cart('Mango', 3)
Antu.checkout(1535)
